...
async function main() {
  ...
  await prisma.user.create({
    data: {
      ...
      firstName: "Sarah",
      lastName: "Johnson",
      email: "manager@gta.com",
      username: "manager@gta.com",
  ...
  await prisma.notification.createMany({
    data: [
      { userId: users[0].id, type: "success", title: "Welcome to GTA CRM", description: "Your account has been set up successfully." },
